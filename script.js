...
document.addEventListener('DOMContentLoaded', function() {
    const elementsToAnimate = document.querySelectorAll('.section-header, .about-content, .program-card, .testimonial, .contact-content');
...
function showNotification(message, type = 'info') {
    ...
    notification.style.cssText = `
        ...
        top: 90px;
        right: 20px;
        background: ${type === 'success' ? '#2c5530' : type === 'error' ? '#e53e3e' : '#3182ce'};
        color: white;
        padding: 1rem 1.5rem;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add subtle animation delay to testimonials
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    focusableElements.forEach(element => {
        element.addEventListener('focus', function() {
            this.style.outline = '2px solid var(--primary-color, #2c5530)';
